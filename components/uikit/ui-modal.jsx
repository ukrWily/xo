...
export const UiModal = ({
  ...
  const modal = (
    <div
      onClick={handleClick}
      className="fixed inset-0 bg-slate-900/50 backdrop-blur pt-10 pb-10 overflow-y-auto"
    >
      <div
        data-id="modal"
        className={clsx(
      ...
      >
        <button
          onClick={onClose}
          className="w-8 h-8 flex items-center justify-center bg-white/10 absolute top-0 left-[calc(100%+12px)] rounded hover:bg-white/40 transition-colors"
        >
